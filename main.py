...
parser.add_argument('--lr', type=float, default=10e-3, help='Learning Rate. Default=0.01')
...
def main():
    ...
    train_set = get_training_set(args.upscale_factor, args.train_set)
    test_set = get_test_set(args.upscale_factor, args.test_set)
