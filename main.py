...
parser.add_argument('--train_set', type=str, default='train/real_bilinear.h5', help='name of train set h5 file.')
parser.add_argument('--logs', type=str, default='./logs/no56/N2-10-4/finetune-real-bilinear',
